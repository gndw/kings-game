...
/// Runs once per simulated day, after [`crate::game::advancing_date::tick`]
/// bumps the date. Holds the per-day building-completion check
/// ([`crate::game::constructing::on_day`]); the schedule exists so
...
/// from [`crate::game::advancing_date::tick`]; holds the monthly economy,
/// currently the tax [`crate::game::paying_out::on_month`].
#[derive(ScheduleLabel, Hash, PartialEq, Eq, Clone, Debug)]
pub struct OnMonth;
