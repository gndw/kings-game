...
/// Runs once per simulated day, after [`crate::game::advancing_date::advance`]
/// bumps the date. Holds the per-day building-completion check
/// ([`crate::game::constructing::construction`]); the schedule exists so
...
/// from [`crate::game::advancing_date::advance`]; holds the monthly economy,
/// currently the tax [`crate::game::paying_out::payout`].
#[derive(ScheduleLabel, Hash, PartialEq, Eq, Clone, Debug)]
pub struct OnMonth;
