...
/// Runs once per simulated day, after [`crate::game::advance_date::advance`]
/// bumps the date. Holds the per-day building-completion check
/// ([`crate::game::construction::construction`]); the schedule exists so
...
/// from [`crate::game::advance_date::advance`]; holds the monthly economy,
/// currently the tax [`crate::game::payout::payout`].
#[derive(ScheduleLabel, Hash, PartialEq, Eq, Clone, Debug)]
pub struct OnMonth;
